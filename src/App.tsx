...
const App = () => (
  <div className="rhulcompsoc">
    ...
    <Link
      to="https://outlook.office365.com/owa/calendar/8ec001cdff644d9d8e0e63646602a521@computingsociety.co.uk/339d3bf686dc471e9fcbcfd8fc5448497927031125383392704/calendar.ics"
      target="_blank"
      download
    >
      Click here to save the calendar!
    </Link>
    <hr />
    <Section title="About Us" tag="What we do">
      <p>
        ...
        external companies in order to increase the diversity of the activities
        that we offer.
      </p>
      <p>
        We support the academics of not only Computer Science, but also Physics,
        Economics, and any other subjects that have a computing component. Our
        support includes hosting workshops in such topics as Java, Python, C,
        and computing-related mathematics, running drop-in sessions for
        questions, and much more. As well as supplementary talks from students,
        we also invite guests from industry to host talks and events that allow
        students to learn and ask questions about graduate schemes, jobs, and
        other opportunities.
      </p>
      <p>
        As well as academic events, we host a number of socials for our members
        to get together. From our weekly Friday pub social, cliché Minecraft
        survival games and other gaming activities, events on our discord
        server, to getting involved with SU club nights with 80s 90s 00s. There
        is always some type of social to get our members involved.
      </p>
    </Section>
    <hr />
    <Section
    ...
    >
      <p>
        We have a standard membership fee of £8, which goes directly to funding
        the events and activities we run throughout the year. By purchasing a
        member you not only support the events we run but also guarantees you
        will be able to attend all of the events we run, along with picking up
        the merchandise we give out throughout the year.
      </p>
    </Section>
    <hr />
    <Section
    ...
    >
      ...
      <p>
        If you want to join our online Discord community and talk to our members
        of past and present, you can join it using the link below.
      </p>
